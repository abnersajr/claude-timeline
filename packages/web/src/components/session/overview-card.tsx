      ...
      <details className="mt-4 rounded-lg border border-[var(--border)] overflow-hidden">
        ...
        <div className="px-4 pb-4 text-sm">
          <dl className="grid grid-cols-[auto_1fr] gap-x-4 gap-y-2">
            ...
            <dt className="font-medium text-[var(--foreground)]">Cache Write (5m / 1h)</dt>
            <dd className="text-[var(--muted-foreground)]">New cached tokens with 5-minute or 1-hour expiry windows.</dd>
